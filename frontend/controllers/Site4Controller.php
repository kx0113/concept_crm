 ...
 * Site controller
 */
class Site4Controller extends BaseController
{
    ...
    public function init(){
        parent::init();
        $this->product_parent=Yii::$app->params['web5']['product_parent'];
        $this->index_product_limit=Yii::$app->params['web5']['index_product_limit'];
        $this->product_limit=Yii::$app->params['web5']['product_limit'];
        $this->news_type=Yii::$app->params['web5']['news_type'];
        $this->news_index_limit=Yii::$app->params['web5']['news_index_limit'];
        $this->news_title=Yii::$app->params['web5']['news_title'];
        $this->news2_title=Yii::$app->params['web5']['news2_title'];
        $this->news_limit=Yii::$app->params['web5']['news_limit'];
        $this->product_title=Yii::$app->params['web5']['product_title'];
        $this->news_title_eng=Yii::$app->params['web5']['news_title_eng'];
        $this->product_title_eng=Yii::$app->params['web5']['product_title_eng'];
        $this->news2_type=Yii::$app->params['web5']['news2_type'];

        Yii::$app->session->set('web_id',Yii::$app->params['web5']['web_id']);
...
//        echo Yii::getVersion();
    ...
    public function common_info(){
        return Yii::$app->CommonClass->common_data_assemble($this->session_web_id,Yii::$app->params['web5']['product_parent']);
    }
    ...
    public function actionProduct2(){
        $type_id=!empty($_REQUEST['type_id']) ? $_REQUEST['type_id'] : "";
        $data=Yii::$app->CommonClass
            ->product_list($type_id,$this->session_web_id,$this->product_limit,Yii::$app->params['web5']['product2_parent']);
        return $this->render('product',[
            'product'=>$data['res'],
            'page'=>$data['page'],
            'tit'=>Yii::$app->params['web5']['product2_title'],
            'common_info'=>$this->common_info(),
        ]);
    }
    /**
    ...
    public function actionArticle1(){
        return $this->render('content',[
            'tit'=>Yii::$app->params['web5']['article_title_1'],
            'cont'=>$this->project(Yii::$app->params['web5']['article_1']),
            'common_info'=>$this->common_info(),
        ]);
    }
    /**
    ...
    public function actionArticle2(){
        return $this->render('content',[
            'tit'=>Yii::$app->params['web5']['article_title_2'],
            'cont'=>$this->project(Yii::$app->params['web5']['article_2']),
            'common_info'=>$this->common_info(),
        ]);
    }
    /**
    ...
    public function actionArticle3(){
        return $this->render('content',[
            'tit'=>Yii::$app->params['web5']['article_title_3'],
            'cont'=>$this->project(Yii::$app->params['web5']['article_3']),
            'common_info'=>$this->common_info(),
        ]);
    }
    /**
    ...
    public function actionArticle4(){
        return $this->render('content',[
            'tit'=>Yii::$app->params['web5']['article_title_4'],
            'cont'=>$this->project(Yii::$app->params['web5']['article_4']),
            'common_info'=>$this->common_info(),
        ]);
    }
    ...
    public function actionIndex()
    {
        return $this->render('index',[
            ...
            'article_title_1'=>Yii::$app->params['web5']['article_title_1'],
            'article_title_eng_1'=>Yii::$app->params['web5']['article_title_eng_1'],
            'article_title_2'=>Yii::$app->params['web5']['article_title_2'],
            'article_title_4'=>Yii::$app->params['web5']['article_title_4'],
